...
function salvarNovo(){
    ...
    var variedade = document.getElementById("txtVariedade").value;
    if(nome !== "" && variedade !== ""){
        location.href="FormProdutos.jsp?nome="+nome+"&variedade="+variedade+"&operacao=SALVAR";
    }
    else{
        var vari = document.getElementById("txtVariedade");
        vari.focus();
    }
}
